...
export default async function ProductPage({ params }: ProductPageProps) {
  ...
  return (
    <section className="shell pb-12 pt-8 sm:pb-16 sm:pt-10">
      <article className="section-frame relative mb-5 overflow-hidden">
        <div className="relative aspect-[16/7] min-h-[220px] sm:min-h-[280px] lg:min-h-[340px]">
          <Image
            ...
            priority
            sizes="100vw"
            className="object-cover object-[72%_center] sm:object-[76%_center]"
          />
      ...
      <div className="grid gap-5 lg:grid-cols-[1.08fr_0.92fr] lg:items-start">
        ...
        <div className="space-y-4">
          <div className="glass-panel p-6 sm:p-7">
            ...
            <h1 className="mt-4 text-4xl uppercase tracking-[0.14em] sm:text-5xl">{product.name}</h1>
            <p className="mt-4 text-base leading-8 text-steel">{product.description}</p>
